...
formalizados en Isabelle/HOL\<close> \<open>[4]\<close> in which we studied Syntax, Semantics and
a propositional version of Hintikka's lemma from the theoretical perspective 
of \<open>First−Order Logic and Automated Theorem Proving\<close> \<open>[5]\<close> by Melvin Fitting. 
...
Compactness\<close> theorem as a consecuence. Inspired by \<open>Propositional Proof Systems\<close> \<open>[10]\<close> by 
