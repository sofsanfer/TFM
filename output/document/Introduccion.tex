...
El objetivo de la Lógica es la formalización del conocimiento y el 
  ...
  Por último, el cuarto capítulo se centra en la demostración del \isa{teorema\ de\ existencia\ de\ modelo}, exponiendo posteriormente la prueba del \isa{teorema\ de\ compacidad} como consecuencia de este. El capítulo está dividido en tres apartados: 
  ...
  Hintikka que, por el \isa{lema\ de\ Hintikka}, es satisfacible. Para ello, empleando los 
  ...
  \isa{S} y \isa{C{\isacharprime}} según el primer apartado del cuarto capítulo, y se probará que el límite de dicha 
