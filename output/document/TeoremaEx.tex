...
\isatagdocument
%
\isamarkupsection{Teorema de existencia de modelo%
}
\isamarkuptrue%
%
\endisatagdocument
...
En esta sección demostraremos el \isa{teorema\ de\ existencia\ de\ modelo}, que prueba 
  ...
  propiedades descritas. Por tanto, por el \isa{lema\ de\ Hintikka}, en las condiciones anteriores el 
...
El siguiente resultado prueba que el límite de la sucesión definida en \isa{{\isadigit{4}}{\isachardot}{\isadigit{1}}{\isachardot}{\isadigit{1}}} es un conjunto
  ...
  es cerrada bajo subconjuntos y es de carácter finito. Como consecuencia del \isa{lema\ de\ Hintikka},
...
De este modo, procedamos finalmente con la demostración del teorema.
  ...
  \begin{demostracion}
    ...
    conjunto de Hintikka. Por tanto, por el \isa{lema\ de\ Hintikka}, se trata de un conjunto 
    satisfacible. 
